        ...
        <div className="product-info">
              ...
              <div className="variant-picker__option-values wrap gap-2">
                {variants.map((variant, index) => (
                  <label
                    ...
                    onClick={() =>
                      !variant.disabled && setSelectedVariant(variant)
                    }
                    style={{
          ...
          <div className="offer bg-custom text-custom">
            <div className="text-with-icon">
              <span style={{ width: 20, height: 20 }}><svg role="presentation" fill="none" focusable="false" stroke-width="2" width="24" height="24" class="icon icon-picto-coupon" viewBox="0 0 24 24">
